...
pixels_20 = [];
pixels_20[0] = neopixel.NeoPixel(board.D19, 960, brightness=LED_BRIGHTNESS, auto_write=False,
pixel_order=LED_ORDER)
pixels_20[1] = neopixel.NeoPixel(board.D26, 960, brightness=LED_BRIGHTNESS, auto_write=False,
pixel_order=LED_ORDER)
pixels_20[2] = neopixel.NeoPixel(board.D26, 960, brightness=LED_BRIGHTNESS, auto_write=False,
pixel_order=LED_ORDER)
